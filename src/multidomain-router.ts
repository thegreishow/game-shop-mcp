export type Domain = "ui" | "motion" | "3d" | "shader" | "video" | "design-reference" | "agent-platform";
...
export type MultiDomainRequest = {
  ...
  framework?: "react" | "vanilla" | "vue" | "phaser" | "three" | "any";
...
const engines: Engine[] = [
  ...
  { id:"threejs", domains:["3d","shader"], capabilities:["scene","webgl","webgpu","gltf","postprocessing","shader","game-3d"], frameworks:["vanilla","three","any"], install:"npm install three", quality:10,speed:8,cost:10,bundle:7,openSource:10,status:"installable",notes:"Primary programmable browser 3D/WebGL/WebGPU engine." },
  ...
  { id:"autoae", domains:["video","motion"], capabilities:["after-effects","template-animation","video"], frameworks:["any"], quality:8,speed:8,cost:6,bundle:10,openSource:2,status:"service",notes:"External video/motion workflow; API/automation contract must be verified before adapter work." },
  ...
  { id:"impeccable", domains:["design-reference","ui"], capabilities:["design-guidance","visual-polish","critique"], frameworks:["any"], quality:9,speed:9,cost:9,bundle:10,openSource:7,status:"reference",notes:"Use as design guidance/reference when available; verify exact integration surface." },
  ...
  { id:"contextcore", domains:["agent-platform"], capabilities:["context","agent-context","workflow"], frameworks:["any"], quality:7,speed:7,cost:7,bundle:10,openSource:5,status:"verify",notes:"Catalogued for investigation; do not invent an integration contract." },
];
