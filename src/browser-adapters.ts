...
export function browserAdapterInfo(){const endpoint=localBrowserEndpoint();return{browserbase:{configured:Boolean(process.env.BROWSERBASE_API_KEY),endpoint:"https://mcp.browserbase.com/mcp",mode:"hosted-stagehand-mcp"},playwright:{configured:Boolean(endpoint),endpoint,mode:"streamable-http-mcp",automaticLocalStart:true,recommendedCommand:"npm run playwright:local"}};}
