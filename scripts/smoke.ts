...
async function main(){
  ...
  console.log(`Future-stack MCP smoke OK: ${tools.length} tools; canonical six-game registry, autonomous jobs, governance, budgets, health, trust, continuity and safety verified.`);
}
